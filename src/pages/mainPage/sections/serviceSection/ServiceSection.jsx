                ...
                <Animate animation="animate__bounceInUp">
                    <div className="serviceList">
                        ...
                        <div className="serviceCard">
                            ...
                            <p className="cardDescription">
                                Regelmäßige Reinigung und Wartung verlängern die Lebensdauer Ihres Dachs und beugen teuren Schäden vor – wir kümmern uns darum zuverlässig und gründlich.                            </p>
                        </div>
                        <div className="serviceCard">
